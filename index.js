/* User Persona WorldForge - v0.9.0 */
const EXT = 'user-persona-worldforge', VERSION = '0.9.0';

// 左侧原版大类与二级分类结构，完全原样锁定
const MENU_TREE = [
  {
    name: '基本信息',
...
// 右侧白色小方块词库：已彻底剔除所有“现代/古代/玄幻”前缀，纯净合并
const TAG_DATABASE = {
  // ===== 基本信息 =====
...
function render() {
  ...
  const curSub = settings.activeSubTab || '发色';
